# 🎯 AI Prompts for English Learning

This folder contains carefully crafted prompts to use with AI assistants (ChatGPT, Claude, Perplexity, GitHub Copilot) to enhance English learning.
...
1. Choose the prompt that matches your learning goal
2. Copy the entire prompt text
3. Paste it into your preferred AI assistant
4. Start your learning session!

## Tips

- Use different AI tools for different purposes
- Combine prompts with your book studies
- Adapt prompts to your specific needs
- Create your own variations as you progress

---

*More prompts will be added as I develop new learning strategies.*
